...
class MoviesFavoriteAdapter internal constructor(): PagedListAdapter<MovieEntity,MoviesFavoriteAdapter.MovieViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MoviesFavoriteAdapter.MovieViewHolder {
